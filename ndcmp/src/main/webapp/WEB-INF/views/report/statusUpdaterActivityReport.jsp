						...
						<div class="col-lg-12">
							...
							<div class="main-box-body clearfix">
									...
									<div class="form-inline form-group rcorners1"
												...
												<div class="col-md-6">
													...
													<div class="col-md-3">
														<select multiple id="reportingPeriodId" class="form-control"
															onchange="loadPartnerQuater(this);" style="width: 320%;">
												...
												<div class="col-md-6">
													...
													<div class="col-md-3">
														<select  multiple class="form-control" id="quaterId"
															...
															onclick="loadPartnerReportPillars(this);" style="width: 320%;">
												...
												<div class="col-md-6">
													...
													<div class="col-md-3">
														<select multiple="multiple"  class="form-control" id="strategicPillarId"
															...
															onchange="loadPartnerReportTheme(this);" style="width: 320%;">
												...
												<div class="col-md-6">
													...
													<div class="col-md-3">
														<select multiple="multiple" class="form-control col-xs-3" name="reporting_id"
															id="themeId" onchange="loadPartnerReportOutcome(this);" style="width: 320%;">
															<option value="0" label="---All---"></option>
														</select>
													</div>
												...
												<div class="col-md-12">
													...
													<div class="col-md-10" style="left: -47px;">
														<select multiple="multiple" class="form-control col-xs-11" name="reporting_id"
															id="outcomeId" onchange="loadPartnerReportOutput(this);" style="width: 104%;">
															<option value="0" label="---All---"></option>
														</select>
													</div>
										...
										<div align="center">
										<br />
											<button class="btn btn-primary" onclick="statusUpdaterActualReportDownload();" >Download</button>
										</div>
										</div>
									</div>
									<div>
												...
												<div class="col-xs-6">
													...
													<div class="col-md-4">
														<select id="yearId" class="form-control"
															onchange="loadReportPillars(this);" style="width: 240px;" multiple="multiple">
															<option value="0" label="---All---"></option>
															<c:forEach items="${reportingPeriods}"
																var="reportingperiod">
												...
												<div class="col-xs-6">
													...
													<div class="col-md-3">
														<select class="form-control" id="strategicPillarId"
															onchange="getThemesByStrategicReport(this);" style="width: 240px;" multiple="multiple"> 
															<option value="0" label="---All---"></option>
												...
												<div class="col-xs-6">
													...
													<div class="col-xs-6">
														<select class="form-control col-xs-3" name="reporting_id"
															id="themeId" onchange="getOutcomesByTheme(this);" style="width: 240px;" multiple="multiple">
															<option value="0" label="---All---"></option>
														</select>
													</div>
												...
												<div class="form-group col-xs-6">
													...
													<div class="col-md-3">
														<select class="form-control col-xs-3" name="reporting_id"
															...
															style="width: 240px;" multiple="multiple">
															<option value="0" label="---All---"></option>
														</select>
													</div>
												</div>
