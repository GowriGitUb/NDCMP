	...
	<div class="container">
		...
		<div>
			<form:form id="targetAddForm" cssClass="form-horizontal"
				...
				<form:hidden path="id" value="${target.id}" />
				<div class="form-group">
					<div class="control-label col-xs-3">
						<form:label path="message" cssClass="labelColor">Target Message : &nbsp;<span
								style="color: red;">*</span>
						</form:label>
					</div>
					<div class="col-xs-6">
						<form:textarea cssClass="form-control" path="message" cols="5" rows="20"
							value="${target.message}" id="message"></form:textarea>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<input type="submit" class="btn btn-primary"
								value="Save" onclick="return submitTargetForm();" />
			...
			$('#targetAddForm').formValidation({
				...
				fields : {
					message : {
						validators : {
							notEmpty : {
								message : 'Target Mssage is required'
							}
						}
					},
					'output.id' : {
